				...
				<div class="panel-body">
					...
					<form method="post" class="form-horizontal">
						<div class="form-group">
							...
							<div class="col-md-10">
								<input type="text" name="nama" id="nama" class="form-control" placeholder="Nama Foodhall ..." value="{{ old('nama') }}" autofocus>
							</div>
						</div>
						<div class="form-group">
							<label for="telp" class="col-md-2 control-label">Telepon Foodhall:</label>
							<div class="col-md-10">
								<input type="text" name="telp" id="telp" class="form-control" placeholder="Telepon Foodhall ..." value="{{ old('telp') }}">
							</div>
						</div>
						<div class="form-group">
							<label for="operator" class="col-md-2 control-label">Operator Telepon:</label>
							<div class="col-md-10">
								<input type="text" name="operator" id="operator" class="form-control" placeholder="Operator Telepon ..." value="{{ old('operator') }}">
							</div>
						</div>
						<div class="form-group">
