...
@section('title')
Daftar Goods Receipt @endsection
	...
	<div class="row">
		<div class="col-md-10 col-md-offset-1">
			<div class="panel panel-default">
				<div class="panel-heading">Daftar Goods Receipt</div>
				<div class="panel-body">
                    ...
                    <div id="toolbar" class="btn-group">
                        <a href="{{ route('tambah-gr') }}" class="btn btn-default" data-toggle="tooltip" data-original-title="Tambah Mobil" data-placement="top">
					...
					<table data-toggle="table" data-pagination="true" data-toolbar="#toolbar">
						...
						<tbody>
<?php $i = 1; ?>
							@foreach($goods_receipt as $gr)
								<tr>
									<td>{{ $i }}</td>
									<td>{{ $gr->main_id }}</td>
									<td>{{ $gr->nama }}</td>
									<td>{{ date("d M Y", strtotime($gr->tgl_masuk)) }}</td>
									<td>{{ $gr->nama_lengkap }}</td>
									<td><a href="{{ route('detail-gr', $gr->main_id) }}">Lihat detail</a></td>
								</tr>
<?php $i++; ?>
							@endforeach
						</tbody>
