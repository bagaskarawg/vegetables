...
@section('title')
Laporan Penjualan Bulanan @endsection
	...
	<div class="row">
		<div class="col-md-12">
			<div class="panel panel-default">
				<div class="panel-heading hidden-print">Laporan Penjualan Bulanan <p class="pull-right"><a href="#" onclick="window.close()" class="btn-sm btn-danger">Tutup halaman</a> <a href="#" onclick="window.print()" class="btn-sm btn-success">Print</a></p></div>
...
<?php $laba = ($pj->harga_dp - $pj->harga_supplier) * str_replace(',', '.', $pj->qty) ?>
							<tr>
								...
								<td>{{ $laba }}</td>
								@if(!isset($detail))
								<td class="hidden-print"><a href="{{ route('detail-laporan-bulanan', $pj->sayur_id) }}" target="_blank">Lebih Detail</a></td>
								@endif
							</tr>
